...
@testset "getindex returns DimensionArray slices with the right dimensions" begin
    ...
    @test dims(a) == (X(LinRange(143.0, 145.0, 2); grid=SampledGrid(span=RegularSpan(2.0))),)
    @test refdims(a) == (Y(-38.0; grid=SampledGrid(span=RegularSpan(2.0))),)
    ...
    @test dims(a) == (Y(LinRange(-38.0, -36.0, 2); grid=SampledGrid(span=RegularSpan(2.0))),)
    @test refdims(a) == (X(143.0; grid=SampledGrid(span=RegularSpan(2.0))),)
    ...
    @test dims(a) == (X(LinRange(143.0, 145.0, 2); grid=SampledGrid(span=RegularSpan(2.0))), 
                      Y(LinRange(-38.0, -36.0, 2); grid=SampledGrid(span=RegularSpan(2.0))))
    @test refdims(a) == ()
...
@testset "view returns DimensionArray containing views" begin
    ...
    @test dims(v) == ()
    @test refdims(v) == (X(143.0; grid=SampledGrid(span=RegularSpan(2.0))), 
                         Y(-38.0; grid=SampledGrid(span=RegularSpan(2.0))))
    @test bounds(v) == ()
    ...
    @test dims(v) == (X(LinRange(143.0, 145.0, 2); grid=SampledGrid(span=RegularSpan(2.0))),)
    @test refdims(v) == (Y(-38.0; grid=SampledGrid(span=RegularSpan(2.0))),)
    ...
    @test dims(v) == (X(LinRange(143.0, 143.0, 1); grid=SampledGrid(span=RegularSpan(2.0))), 
                      Y(LinRange(-38, -36, 2); grid=SampledGrid(span=RegularSpan(2.0))))
    ...
    @test dims(v) == (Y(LinRange(-38.0, -36.0, 2); grid=SampledGrid(span=RegularSpan(2.0))),)
    @test refdims(v) == (X(143.0; grid=SampledGrid(span=RegularSpan(2.0))),)
...
@testset "broadcast" begin
    ...
    @test dims(da2) == 
        (Y(LinRange(10, 20, 5); grid=SampledGrid(span=RegularSpan(2.5))), 
