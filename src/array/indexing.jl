...
@propagate_inbounds Base.setindex!(A::AbstractDimArray, x, i::DimensionalIndices, I::DimensionalIndices...; kw...) =
    setindex!(A, x, dims2indices(A, _simplify_dim_indices(i, I..., kw2dims(values(kw))...)...)
